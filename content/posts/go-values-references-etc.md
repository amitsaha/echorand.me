...
A **deep copy** of an variable/object is a copy of an object and it's containing elements (if any) 
such that the copy and the original object occupy different *memory addresses*.
